...
* [Install OpenCV(python) on Ubuntu](https://docs.opencv.org/4.5.0/d2/de6/tutorial_py_setup_in_ubuntu.html)
* [RM Blog](https://bbs.robomaster.com/forum.php?mod=forumdisplay&fid=63&filter=typeid&typeid=13)
* [Download and Install JetPack (for TX2 only)](install-jetpack.md)
...
* [Armor Plate Recognition(Color and Number)](armor-plate-recognition.md)
